...
const { 'board-id': _boardId, 'board-key': _boardKey, 'ticket-type': _ticketType, ...ticketUpdateBody } = ticketCreateBody;
const ticketUpdateWithClearBody = {
    ...
    'clear-tags': { apiName: 'tags', type: 'switch', constant: null },
