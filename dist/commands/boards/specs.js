...
function boardChildScope(suffix, childFlag, childParam) {
...
function legacyBoardScope(suffix = '', positionalName = 'id') {
    return {
        ...boardScope(suffix),
        positionals: [{
                name: positionalName,
...
const boardCreateBody = {
    ...
    prefix: { apiName: 'prefix', format: 'board-key' }, emoji: { apiName: 'emoji', maxLength: 20 },
    'columns-json': { apiName: 'columns', type: 'json-array' },
    'settings-json': { apiName: 'settings', type: 'json-object' },
};
const { type: _type, ...boardUpdateBody } = boardCreateBody;
const settingsBody = {
    'default-view': { apiName: 'defaultView', choices: ['board', 'list', 'timeline'] },
    'show-swimlanes': { apiName: 'showSwimlanes', type: 'boolean' },
};
