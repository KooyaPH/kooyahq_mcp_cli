...
export async function installCursorIntegration(dependencies: SetupDependencies): Promise<void> {
...
function cursorConfigPath(dependencies: SetupDependencies): string {
