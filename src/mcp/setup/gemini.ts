...
export async function installGeminiIntegration(dependencies: SetupDependencies): Promise<void> {
...
export async function doctorGeminiIntegration(
...
function geminiConfigPath(dependencies: SetupDependencies): string {
